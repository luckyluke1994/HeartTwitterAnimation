package com.example.framgiamaidaidien.hearttwitteranimation.ui;
...
import com.example.framgiamaidaidien.hearttwitteranimation.Utils;
...
public class CircleView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        maxCircleSize = w / 2;
        Log.d("maxCircleSize", ""+maxCircleSize);
